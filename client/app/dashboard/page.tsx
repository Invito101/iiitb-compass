...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen flex flex-col overflow-auto">
      ...
      {/* Button Section */}
      <div className="flex-1 p-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 overflow-auto">
        {[...Array(8)].map((_, i) => {
          ...
          return (
            <Link key={i} href={href} target={href.startsWith("http") ? "_blank" : undefined}>
